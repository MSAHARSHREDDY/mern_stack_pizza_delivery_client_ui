...
import {  CartItem as Item,changeQty } from '@/lib/store/features/cart/cartSice';
    ...
    return (
        <>
            <div className="grid grid-cols-2">
                {/*****It is used for displaying the image *****/}
                ...
                {/*****It is used for displaying qty ****/}
                <div className="flex items-center gap-4 justify-between">
                    <div>
                        {/**It is rendering the  QtyChanger component*/}
                        <QtyChanger
