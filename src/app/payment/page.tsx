...
//This page is completely comming from backend no where related to front end
...
const Payment = ({
    ...
    return (
        <>
            {isOrderSuccess && <CartCleaner />}{/**As this page is server component and cart is client component so we need to integrate server component inside client component so we have created separate component and write "use client" and need to use "useEffect hook" */}
                        ...
                        <CardHeader className="p-4">
                            <CardTitle className="flex items-start text-lg justify-between gap-12">
                                <div className="flex item-center gap-3">
                                    <Store size={35} className="text-orange-800 bold" />
                                    <span>Your order information</span>
                                </div>
                                <Badge className="text-base text-white bg-orange-400 bold px-4" variant={'secondary'}>
                                    Confirmed
                                </Badge>
                            </CardTitle>
                        </CardHeader>
